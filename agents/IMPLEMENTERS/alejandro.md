...
## DOMINIO
Arquitecto experto en TODO el framework de capital allocation. Kelly fraccional, correlation-based adjustment, CVaR, volatility targeting, margin buffers, position sizing. Valido que el algoritmo分配capital de forma institucional y robusta — no con heurísticas ad-hoc.
